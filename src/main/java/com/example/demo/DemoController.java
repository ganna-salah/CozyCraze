...
public class DemoController {
    ...
    public String homeRegister(HREGFormObject formObject,Model model){
    ...
    public String submitForm(REGFormObject yourFormObject,Model model,Model model2) {
        DemoServicesIMPL trial=new DemoServicesIMPL();
        System.out.println(trial.connection);
    ...
    public String homeLogin(HloginFormObject formObject,Model model,Model model1) {
    DemoServicesIMPL trial=new DemoServicesIMPL();
        System.out.println(trial.connection);
        ...
        if(result==true){
            ...
            //model.addAttribute("scripttrial22", "null");
            return "main";
        }
        else{
