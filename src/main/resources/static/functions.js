...
//   var searchtxt=document.getElementById("search-input").value.toLowerCase();
//   var stickers=document.getElementById("stikcer-container").getChildren();
//   stickers.forEach(function(sticker){
//     if(sticker.getClassName.includes(searchtxt)){
//       document.getElementById("stikcer-container").appendChild(sticker)
//     }
//     else{
...
// function searchStickers() {
//     var searchTxt = document.getElementById("search-input").value.toLowerCase();
//     var images = document.querySelectorAll("#stikcer-container img");

//     images.forEach(function(image) {
//         var imageClass = image.className.toLowerCase();
//         if (imageClass.includes(searchTxt)) {
...
//   // Get all images with class "img-item"
//   var images = document.getElementsByClassName("search-input");
